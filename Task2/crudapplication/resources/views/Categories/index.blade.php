                            ...
                            <table class="table">
                                ...
                                @foreach($Categories as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->user_id }}</td>
                                        <td>
                                            <a href="{{ url('/Categories/' . $item->id) }}" title="View ID"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/Categories/' . $item->id . '/edit') }}" title="Edit Data"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
